...
from Wrappers.flatten_action import Flatten_Action
...
def parse_arguments():
    ...
    parser.add_argument('--timesteps', type=int, default=400000, help='specify number of timesteps to train for')
...
def main():
    ...
    if args.rlbench:
        ...
        if flag:
            ...
            env_fn = lambda:  Serialize_Env(InukshukEnv_v0())
