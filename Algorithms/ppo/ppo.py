...
class PPO:
    def __init__(self, env_fn, save_dir, ac_kwargs=dict(), seed=0, tensorboard_logdir = '.',
            ...
            for t in range(self.steps_per_epoch):
                ...
                if terminal or epoch_ended:
                    ...
                    if len(x) > 0:
                        ...
                        if self.env.spec is not None and self.env.spec.reward_threshold is not None and self.best_mean_reward >= self.env.spec.reward_threshold:
