...
def parse_arguments():
    ...
    parser.add_argument('--env', type=str, default='InukshukEnv_v0', help='environment_id')
    ...
    parser.add_argument('--render', action='store_true', default=True, help='if true, display human renders of the environment')
    parser.add_argument('--gif', action='store_true', help='if true, make gif of the trained agent')
    parser.add_argument('--timesteps', type=int, default=1000, help='specify number of timesteps to train for')
...
def main():
    ...
    if args.rlbench:
        ...
        env_fn = lambda: Serialize_Env(InukshukEnv_v0(True))
